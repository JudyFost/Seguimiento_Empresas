...
<center>
	<select style="visibility:hidden" name="formal" onchange="javascript:handleSelect(this)">
	    <option value="graficas3"> - Selecciona - </option>
		<option value="graficas3">Gráfica Residencia profesional</option>
	</select>
</center>
