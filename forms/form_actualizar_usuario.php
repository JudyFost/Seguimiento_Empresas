<!--Aquì se mandan llamar el archivo funciones.js que se encuentra dentro de la carpeta js,el cúal nos sirve para validar los campos que llevan solo letras o números-->
<script src="../js/funciones.js"></script>
 
<!--Formulario para actualizar usuario responsable-->
<?php
echo '                <form method="post" action="../queries/actualizar_usuario.php">';
