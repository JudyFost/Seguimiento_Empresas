      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="../queries/guardar_nueva_solicitud.php" class="">
                    <?php
                    ...
                    <label for="empresa" class="control-label col-sm-4">EMPRESA:<font color="red"> * </font></label>
                      <div class="col-sm-6">
                        <select class="form-control input-sm" id="empresa" name="empresa" onchange="buscar_departamento()" required>
                          <?php
                              include("../include/conexion.php");
                                    $sqlempresa=mysql_query("SELECT * FROM empresa ORDER BY nombre");
                                     echo'<OPTION VALUE="">'.'- Selecciona -'.'</OPTION>';
                                    while($rowempresa = mysql_fetch_array($sqlempresa))
                            {
                            echo'<OPTION VALUE="'.$rowempresa['idempresa'].'">'.utf8_encode($rowempresa['nombre']).'</OPTION>';
                            }
                            ?> 
                      </select>
                    </div>
                    ...
                    <label for="horario_fin" class="control-label col-sm-4">HORA FIN:</label>
					  ...
					  <br>
                      <br>
                    <label for="nivel_ingles" class="control-label col-sm-4">NIVEL INGLES:</label>
                      <div class="col-sm-6">
                    ...
                    <br>
                     ...
                     <label for="promedio" class="control-label col-sm-4">PROMEDIO:</label>
					  ...
					  <br>
					  <br>
                     <label for="beca" class="control-label col-sm-4">BECA:</label>
                      <div class="col-sm-6">
