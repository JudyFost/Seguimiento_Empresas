           ...
           <?php
                  if(isset($_SESSION['almacenado'])){
                      if($_SESSION['almacenado']=="Y"){
                          ...
                          echo '  <h6 style="text-align:center;"><b> Usuario actualizado correctamente</b></h6>';
                          echo '  </div>';   
                      }
                      if($_SESSION['almacenado']=="F"){
                          echo '<div class="alert alert-danger">';
                          echo '  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> ';
                          echo '  <h6 style="text-align:center;"><b>Fallo al actualizar al nuevo usuario !</b></h6>';
                          echo '  </div>';       
                      }
            ...
            <button type="button" class="btn btn-default btn-xs" data-toggle="modal"  style="color:green;" data-target="#window_form_add_user">
              <i class="fa fa-plus-circle fa-1x" aria-hidden="true"> Agregar Usuario</i>
            </button>
     </div>
     <?php
              ...
              <div class="form-group col-xs-12">        
                 <form name="form_usuarios" method="post" action="" class="form-inline">
                  ...
                  <div class="form-group col-xs-2">    
                        ...
                        <option value="id_usuario">Usuario (Tipo)</option>
