...
$sql_consulta=mysql_query("SELECT idempresa,nombre_empresa  FROM responsable_empresa where idusuario='$idusuario_user' and nombre_empresa LIKE '$txtabuscar%' AND nombre_empresa LIKE '$txtabuscar%' order by iddepartamento;");
 ...
 // echo "empresa:".$nombre_empresa;
  ...
  if($tipoopcion=="nombre_empresa"){
	  if($txtabuscar==NULL){
		  $sql_consulta=mysql_query("SELECT * FROM solicitudes_varios_estatus where nombre_empresa='$nombre_empresa' and nombre_empresa LIKE '$txtabuscar%' AND nombre_empresa LIKE '$txtabuscar%' order by iddepartamento;");
	  }
      else{
      $sql_consulta=mysql_query("SELECT * FROM solicitudes_varios_estatus where nombre_empresa='$nombre_empresa' and nombre_empresa LIKE '$txtabuscar%' AND nombre_empresa LIKE '$txtabuscar%' order by iddepartamento;");  
	  }
...
//fin de ventanas modal actualizar situación        
 /////////modificar estatus de las solicitudes
                                      ...
                                      echo '        </div>';
                                      echo '        <div class="modal-body">';
                                      include ('../forms/form_actualizar_solicitud_empresa.php');  ///incluyo el formulario
                                      echo '        </div>';
                                      echo '      </div>';
                                      echo '    </div>';
                                      echo '  </div>';              
