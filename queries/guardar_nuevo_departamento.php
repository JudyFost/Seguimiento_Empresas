...
$nombre_departamento=utf8_decode(strtoupper($_POST['nombre']));
...
$sql="INSERT INTO departamento (iddepartamento, empresa_idempresa, usuario_idusuario, nombre) VALUES ('$idepartamento', '$idempresa', '$idusuario', upper('$nombre'))";
	if(mysql_query($sql)){
