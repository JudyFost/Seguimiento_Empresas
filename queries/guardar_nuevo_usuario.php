<!--Consulta para guardar al nuevo usuario responsable de las solicitudes-->
<?php
...
$sql="INSERT INTO usuario VALUES ('$idusuario',upper('$nombre'),upper('$ap_paterno'),upper('$ap_materno'),$tipo_usuario,'$password',upper('$puesto'),'$sexo','$correo','$telefono',upper('$direccion'));";
	if(mysql_query($sql)){
		//Código para iniciar una nueva sesión o reanudar la existente
		session_start();
		//Aquì se manda a llamar la variable de sesión con el valor Y, el cual mandara el siguiente mensaje: Usuario guardado correctamente
